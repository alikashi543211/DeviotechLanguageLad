                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span><span class="website_currency_code currency_unit">USD</span><span class="website_amount_html_usd" amount-usd="{{ $item->amount ?? '0' }}">{{ $item->amount + $item->admin_amount ?? '0' }}</span></span></td>
                                    </tr>
                                    @endforeach
                                </tbody>
    	                        </table>
