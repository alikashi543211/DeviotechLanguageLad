                                ...
                                <tbody>
                                    @foreach ($list as $item)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href="{{ route('student.package.detail', $item->id) }}" title="View Detail" data-title="Are you sure want to send the refund request?" data-href="" class="btn btn-info mr-1"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('student.package.lessons', $item->id) }}" title="Lessons" data-title="Are you sure want to send the refund request?" data-href="" class="btn btn-success mr-1"><i class="fa fa-list"></i></a>
                                                @if($item->status == '1')
                                                    <a href="{{ route('student.package.schedule', $item->id) }}" title="Schedule New Booking" data-title="Are you sure want to send the refund request?" data-href="" class="btn btn-warning mr-1"><i class="fa fa-clock-o"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
