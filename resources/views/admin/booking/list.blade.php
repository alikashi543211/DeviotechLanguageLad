                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($item->refund_status == '1')
                                            <a href="javascript:void(0);" onclick="alertMessage('{{ route('admin.bookings.refund.payment', $item->id) }}', 'Cancel And Refund Payment', 'Are you sure want to cancel and refund payment ${{ $item->amount }}?', 'Yes! Cancel And Refund', '#4CAF50')" rel="tooltip" class="btn btn-primary btn-round" data-original-title="View Detail" title="Cancel and Refund Payment">
                                                <i class="material-icons">request_quote</i>
                                            </a>
                                        @endif
                                        <a href="{{ route('admin.bookings.detail', $item->id) }}" rel="tooltip" class="btn btn-info btn-round" data-original-title="View Detail" title="View Detail">
                                            <i class="material-icons">visibility</i>
                                        </a>
                                        <button type="button" onclick="deleteAlert('{{ route('admin.bookings.delete', $item->id) }}')" rel="tooltip" class="btn btn-danger btn-round delete-btn" data-original-title="Delete" title="Delete">
