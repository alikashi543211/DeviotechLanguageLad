...
@section('subject', 'Profile Approved')
@section('content')

	<div>
	    <h1 align="center" style="color: #2b3248;font-size:24px;font-weight:bold;margin-top: 30px;text-transform:none;font-family: sans-serif;line-height: 1.4;margin-bottom: 30px;">Profile Not Approved</h1>
	</div>

	<p style="font-family: sans-serif;text-align:center;color:grey;font-size:16px;margin-bottom: 30px;">
		We are very sorry, but we are currently unable to accept your application as a teacher. However, you are welcome to reapply after a period of time.
	</p>
