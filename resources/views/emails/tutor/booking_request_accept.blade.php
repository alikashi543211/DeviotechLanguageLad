...
@section('content')
	...
	<p style="font-family: sans-serif;text-align:justify;color:grey;font-size:16px;margin-bottom: 30px;"><b>@if($booking->channel_type == "Zoom") Zoom Link: @elseif($booking->channel_type == "Zoom") Zoom Link: @endif</b>{{ $booking->channel ?? '' }}</p>
