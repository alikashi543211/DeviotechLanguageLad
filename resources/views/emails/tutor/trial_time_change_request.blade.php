...
@section('content')
	<div>
	    <h1 align="center" style="color: #2b3248;font-size:24px;font-weight:bold;margin-top: 30px;text-transform:none;font-family: sans-serif;line-height: 1.4;margin-bottom: 30px;">Trial Time Table Change Request</h1>
	</div>
	<p style="font-family: sans-serif;text-align:justify;color:grey;font-size:16px;margin-bottom: 30px;"><b>Trial ID: </b>{{ $res_request->id }}</p>
	<p style="font-family: sans-serif;text-align:justify;color:grey;font-size:16px;margin-bottom: 30px;"><b>Student Name: </b>{{$res_request->student->name}}</p>
	...
	<p style="font-family: sans-serif;text-align:justify;color:grey;font-size:16px;margin-bottom: 30px;"><b>Slots: </b>{{ showTeacherSlot($res_request->student->timezone, $res_request->tutor->timezone, $res_request->req_start_time, $res_request->req_end_time) }}</p>
