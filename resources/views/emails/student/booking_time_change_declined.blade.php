...
@section('content')
	...
	<div>
	    <h1 align="center" style="color: #2b3248;font-size:24px;font-weight:bold;margin-top: 30px;text-transform:none;font-family: sans-serif;line-height: 1.4;margin-bottom: 30px;">Booking Time Table Change Declined</h1>
	</div>
	...
	<p style="font-family: sans-serif;text-align:justify;color:grey;font-size:16px;margin-bottom: 30px;"><b>Requested By: </b>{{ $booking->time_request_by ?? '' }}</p>
	<p style="font-family: sans-serif;text-align:justify;color:grey;font-size:16px;margin-bottom: 30px;"><b>Declined By: </b>
		@if(isset($booking->time_request_by))
			@if($booking->time_request_by == 'Teacher')
				Student
			@else
				Teacher
			@endif
