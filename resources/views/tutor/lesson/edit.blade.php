					...
					<form method="post" action="{{ route('tutor.lesson.save') }}" enctype="multipart/form-data" class="validate_my_form">
							...
							<div class="row clearfix">
								...
								<div class="form-group col-lg-12 col-md-12 col-sm-12">
									<label>Title*</label>
									<input type="text" name="title" class="@error('name') is-invalid @enderror valid-control" required>
...
@section('js')
	<script>
        ...
        var data = <?php echo json_encode($tutor_lesson) ?>;
        ...
        var speaking_data = <?php echo json_encode($tutor_lesson->tutor_lesson_packages->toArray()) ?>;
        ...
        @if($tutor_lesson->availability == '0')
        	$(".availability").click();
    	@endif
