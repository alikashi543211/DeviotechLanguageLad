                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="tabs-box profile-tabs">
                            <ul class="tab-btns tab-buttons clearfix">
                                ...
                                <li data-tab="#pending_requests" class="tab-btn active-btn">
                                    <a data-toggle="tab" href="#pending_requests">              Requests      
                                        @if($booking_list_time > 0 || $booking_list_cancel > 0)
                                            <span class="fa fa-circle" style="font-size:10px;color:red;"></span>
                                        @endif
                                    </a>
                                </li>
                                <li data-tab="#active_requests" class="tab-btn">
                                    <a data-toggle="tab" href="#active_requests">Active</a>
                                </li>
                                <li data-tab="#completed_requests" class="tab-btn">
                                    <a data-toggle="tab" href="#completed_requests">Completed</a>
                                </li>
                                <li data-tab="#cancelled_requests" class="tab-btn">
                                    <a data-toggle="tab" href="#cancelled_requests">Cancelled</a>
                                </li>
                            </ul>
                            <div class="tabs-content">
                                <div class="tab active-tab" id="pending_requests">

                                </div>

                                <div class="tab" id="active_requests">

                                </div>

                                <div class="tab" id="completed_requests">

                                </div>

                                <div class="tab" id="cancelled_requests">
            ...
            <div class="modal-content dashboard-section p-0">
                <form action="" method="POST" class="custom-offer-form">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="" class="delete_btn"><button type="button" class="btn btn-danger">Cancel</button></a>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content dashboard-section p-0">
                <div class="styled-form">
                    <form action="" method="GET" class="custom-offer-form crm_form">
                        <div class="modal-header">
                            <h5 class="modal-title main_title" id="exampleModalLongTitle">Cancel Booking</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="modal-content dashboard-section p-0">
                <div class="styled-form">
                    <form action="" method="GET" class="custom-offer-form accept_request_modal">
                        <div class="modal-header">
                            <h5 class="modal-title main_title" id="exampleModalLongTitle">Accept Request</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content dashboard-section p-0">
                <div class="styled-form">
                    <form action="" method="GET" class="custom-offer-form crm_form">
                        <div class="modal-header">
                            <h5 class="modal-title main_title" id="exampleModalLongTitle">Student Booking Cancel Request</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
...
@section('js')
    <script>
        ...
        load_pending_requests("{{ route('tutor.booking_request.load.list') }}", '#pending_requests');
        load_active_requests("{{ route('tutor.booking_request.load.active') }}", '#active_requests');
        load_completed_requests("{{ route('tutor.booking_request.load.completed') }}", '#completed_requests');
        load_cancelled_requests("{{ route('tutor.booking_request.load.cancelled') }}", '#cancelled_requests');


        function load_pending_requests($url, $tab)
        {
            $.ajax({
                type: "GET",
                url: $url,
        ...
        function load_active_requests($url, $tab)
        {
            $.ajax({
                type: "GET",
                url: $url,
        ...
        function load_completed_requests($url, $tab)
        {
            $.ajax({
                type: "GET",
                url: $url,
        ...
        function load_cancelled_requests($url, $tab)
        {
            $.ajax({
                type: "GET",
                url: $url,
        ...
        $(document).on("click", '.accept_icon_btn', function(){
            ...
            {
                $(".accept_button_elem").html("Go To Reschedule Booking");  
            }else
            {
